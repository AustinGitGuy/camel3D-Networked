...
{
	const a3ui32 minimum = sizeof(c3_DemoState);
	a3ui32 size = 1;
	while (size < minimum)
		size += size;
	return size;
...
inline void a3demoCB_keyCharPress_main(c3_DemoState *demoState, a3i32 asciiKey,
...
inline void a3demoCB_keyCharHold_main(c3_DemoState *demoState, a3i32 asciiKey)
{
...
extern "C"
{
	...
	A3DYLIBSYMBOL c3_DemoState *a3demoCB_load(c3_DemoState *demoState, a3boolean hotbuild);
	A3DYLIBSYMBOL c3_DemoState *a3demoCB_unload(c3_DemoState *demoState, a3boolean hotbuild);
	A3DYLIBSYMBOL a3i32 a3demoCB_display(c3_DemoState *demoState);
	A3DYLIBSYMBOL a3i32 a3demoCB_idle(c3_DemoState *demoState);
	...
	A3DYLIBSYMBOL void a3demoCB_keyHold(c3_DemoState *demoState, a3i32 virtualKey);
	A3DYLIBSYMBOL void a3demoCB_keyRelease(c3_DemoState *demoState, a3i32 virtualKey);
	A3DYLIBSYMBOL void a3demoCB_keyCharPress(c3_DemoState *demoState, a3i32 asciiKey);
	A3DYLIBSYMBOL void a3demoCB_keyCharHold(c3_DemoState *demoState, a3i32 asciiKey);
	A3DYLIBSYMBOL void a3demoCB_mouseClick(c3_DemoState *demoState, a3i32 button, a3i32 cursorX, a3i32 cursorY);
	A3DYLIBSYMBOL void a3demoCB_mouseDoubleClick(c3_DemoState *demoState, a3i32 button, a3i32 cursorX, a3i32 cursorY);
	A3DYLIBSYMBOL void a3demoCB_mouseRelease(c3_DemoState *demoState, a3i32 button, a3i32 cursorX, a3i32 cursorY);
	A3DYLIBSYMBOL void a3demoCB_mouseWheel(c3_DemoState *demoState, a3i32 delta, a3i32 cursorX, a3i32 cursorY);
	A3DYLIBSYMBOL void a3demoCB_mouseMove(c3_DemoState *demoState, a3i32 cursorX, a3i32 cursorY);
	A3DYLIBSYMBOL void a3demoCB_mouseLeave(c3_DemoState *demoState);
